# Generated by Django 4.1.5 on 2023-03-14 05:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_ky', models.CharField(max_length=255, null=True, verbose_name='Название комнаты')),
                ('title_ru', models.CharField(max_length=255, null=True, verbose_name='Название комнаты')),
                ('title_en', models.CharField(max_length=255, null=True, verbose_name='Название комнаты')),
                ('description', models.TextField(verbose_name='Описание комнаты')),
                ('description_ky', models.TextField(null=True, verbose_name='Описание комнаты')),
                ('description_ru', models.TextField(null=True, verbose_name='Описание комнаты')),
                ('description_en', models.TextField(null=True, verbose_name='Описание комнаты')),
